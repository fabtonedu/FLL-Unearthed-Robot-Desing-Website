...
const t = {
  hu: {
    ...
    subtitle: 'Mert a tudás mindenkié. A teljes robotprogramunk, a MyBlock könyvtárunk és a dokumentációnk elérhető a GitHubon. Töltsd le, tanulj belőle, építsd tovább.',
    repoLabel: 'Public Repository',
    repoDesc: 'A teljes Python forráskód, beleértve a menü- és programválasztó modult, a színszenzor-kalibráló rutint, az akkumulátor-ellenőrző kódokat és a küldetés-specifikus szekvenciákat.',
    viewBtn: 'Megtekintés',
    viewBtnMobile: 'Megtekintés GitHub-on',
    latestCommit: 'Latest commit: 2 days ago',
  },
  en: {
    title: 'Open Source.',
    subtitle: 'Because knowledge belongs to everyone. Our complete robot program, MyBlock library, and documentation are available on GitHub. Download it, learn from it, build on it.',
    repoLabel: 'Public Repository',
    repoDesc: 'The complete Python source code, including the menu and program selector module, the color sensor calibration routine, battery check codes, and mission-specific sequences.',
    viewBtn: 'View',
    viewBtnMobile: 'View on GitHub',
    latestCommit: 'Latest commit: 2 days ago',
  },
};
          ...
          <div className="flex items-start justify-between mb-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-[#86868b]">{c.repoLabel}</p>
              </div>
            </div>
            <a
